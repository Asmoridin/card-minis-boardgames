...
if os.getcwd().endswith('card-minis-boardgames'):
    ...
    in_file = open('win_loss/DB/ASOIAFResults.txt', 'r', encoding="UTF-8")
    ARMY_DATA_F = 'minis_games/DB/ASOIAFData.txt'
else:
    out_file_h = open("output/ASOIAFWLOut.txt", 'w', encoding="UTF-8")
    in_file = open('DB/ASOIAFResults.txt', 'r', encoding="UTF-8")
    ARMY_DATA_F = '../minis_games/DB/ASOIAFData.txt'
