...
if os.getcwd().endswith('card-minis-boardgames'):
    out_file_h = open("win_loss/output/SWArmadaOut.txt", 'w', encoding="UTF-8")
    in_file = open('win_loss/DB/SWArmadaWL.txt', 'r', encoding="UTF-8")
    cmdr_data_file = open('win_loss/DB/SWArmadaCommanders.txt', 'r', encoding="UTF-8")
else:
    out_file_h = open("output/SWArmadaOut.txt", 'w', encoding="UTF-8")
    in_file = open('DB/SWArmadaWL.txt', 'r', encoding="UTF-8")
    cmdr_data_file = open('DB/SWArmadaCommanders', 'r', encoding="UTF-8")
