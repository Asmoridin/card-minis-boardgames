...
if os.getcwd().endswith('card-minis-boardgames'):
    out_file_h = open("win_loss/output/XWingOut.txt", 'w', encoding="UTF-8")
    in_file = open('win_loss/DB/XWingWL.txt', 'r', encoding="UTF-8")
else:
    out_file_h = open("output/XWingOut.txt", 'w', encoding="UTF-8")
    in_file = open('DB/XWingWL.txt', 'r', encoding="UTF-8")
