...
if os.getcwd().endswith('card-minis-boardgames'):
    out_file_h = open("win_loss/output/DoomtownOut.txt", 'w', encoding="UTF-8")
    in_file = open('win_loss/DB/DoomtownData.txt', 'r', encoding="UTF-8")
    outfit_data_file = open('win_loss/DB/DoomtownOutfits.txt', 'r', encoding="UTF-8")
else:
    out_file_h = open("output/DoomtownOut.txt", 'w', encoding="UTF-8")
    in_file = open('DB/DoomtownData.txt', 'r', encoding="UTF-8")
    outfit_data_file = open('DB/DoomtownOutfits', 'r', encoding="UTF-8")
...
double_print("\nMy record by outfit:", out_file_h)
