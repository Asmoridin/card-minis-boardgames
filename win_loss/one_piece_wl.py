...
if os.getcwd().endswith('card-minis-boardgames'):
    out_file_h = open("win_loss/output/OnePieceWLOut.txt", 'w', encoding="UTF-8")
    in_file = open('win_loss/DB/OnePieceResults.txt', 'r', encoding="UTF-8")
    source_data_file = open('card_games/DB/OnePieceData.txt', 'r', encoding="UTF-8")
else:
    out_file_h = open("output/OnePieceWLOut.txt", 'w', encoding="UTF-8")
