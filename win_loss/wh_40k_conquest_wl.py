...
if os.getcwd().endswith('card-minis-boardgames'):
    out_file_h = open("win_loss/output/WH40KConquestOut.txt", 'w', encoding="UTF-8")
    in_file = open('win_loss/DB/WH40KConquestWL.txt', 'r', encoding="UTF-8")
    warlord_data_file = open('win_loss/DB/WH40KConquestWarlords.txt', 'r', encoding="UTF-8")
else:
    out_file_h = open("output/WH40KConquestOut.txt", 'w', encoding="UTF-8")
    in_file = open('DB/WH40KConquestWL.txt', 'r', encoding="UTF-8")
    warlord_data_file = open('DB/WH40KConquestWarlords', 'r', encoding="UTF-8")
